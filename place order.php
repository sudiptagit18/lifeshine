...
<br>
	<head>
		...
		<style type="text/css">
			*{
			...
			body{
				background:url(lifeshine_image/Order.jpg);
	...
	<body>
		<div class="regform"><h1><i>Order Now</i></h1></div>
			...
			<form>
				...
				<input class="address" type="text" placeholder="Enter Your Current Address" name="address">
						...
						<option>+91</option>
			      		...
			      		<h2 class="name">Your Products</h2>
				<input class="address" type="text" placeholder="Enter Your needs" name="address">
				...
				<button type="submit"><a href="home.html">Order</button></a>
